...
local Button = {
	...
	add = function(self, name, func, xMin, yMin, xMax, yMax, active, inactiveColor, activeColor, inactiveText, activeText)
	...
	getActive = function(self, name)
		return self.buttonList[name].active
	end,
	setActive = function(self, name, state, noDraw)
